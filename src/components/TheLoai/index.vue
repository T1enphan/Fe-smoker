           ...
           <div class="card">
               ...
               <div class="card-body">
                   <div class="mt-2">
                       ...
                       <input v-model="create_the_loai.ten_the_loai" type="text" class="form-control mt-1">
                   </div>
                   <div class="mt-2">
                       <label>Slug Thể Loại</label>
                       <input v-model="create_the_loai.slug_the_loai" type="text" class="form-control mt-1">
                   </div>
                   <div class="mt-2">
                           ...
                           <thead>
                               ...
                               <th colspan="100%">
                                   <div class="input-group mb-3">
                                       <input  v-on:keyup.enter="searchTheLoai()"  v-model="key_search.abc" type="text" class="form-control" placeholder="Nhập thông tin cần tìm">
                               ...
                               <div class="modal-body">
                                   <div class="row">
                                       <div class="col-12">
                                           ...
                                           <input v-model="edit_the_loai.ten_the_loai" type="text"
                                   ...
                                   <div class="row mt-2">
                                       <div class="col-12">
                                           ...
                                           <input v-model="edit_the_loai.slug_the_loai" type="text"
                                               class="form-control mt-2">
                                       </div>
                                   </div>
                                   <div class="row mt-2">
